    ...
    <div className="fixed inset-0 z-[200] flex items-start justify-center pt-[15vh] sm:pt-[20vh] bg-slate-950/60 backdrop-blur-sm px-4">
      ...
      >
        <div className="flex items-center border-b border-slate-100 dark:border-slate-800 px-3">
          <Command.Input 
            autoFocus
            placeholder="Ketik perintah atau cari (contoh: theme, contact)..." 
        ...
        <Command.List className="max-h-[300px] overflow-y-auto p-2 scrollbar-hide">
          ...
          <Command.Group heading="Navigasi" className="text-xs font-semibold text-slate-500 px-2 py-2 mb-1">
            <Command.Item 
              onSelect={() => runCommand(() => {
          ...
          <Command.Group heading="Aksi" className="text-xs font-semibold text-slate-500 px-2 py-2 mb-1 mt-2">
            <Command.Item 
              onSelect={() => runCommand(() => {
            ...
            >
              <div className="flex items-center gap-3">
                ...
                Ganti Tema Mode {theme === "dark" ? "Terang" : "Gelap"}
              </div>
            </Command.Item>
          </Command.Group>
        </Command.List>
